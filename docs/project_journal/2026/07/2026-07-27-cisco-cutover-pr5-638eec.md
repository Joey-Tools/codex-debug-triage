...
- Fresh-review repair suite on Python 3.13.0: 243 tests passed, including fixed-transport redirect refusal, post-child signal injection, and equal-length ZIP metadata rewrites.
