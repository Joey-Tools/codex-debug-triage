...
- The hosted macOS ACL integration now runs the fixed-curl directory-ACL regression explicitly, so Darwin descriptor-ACL enforcement cannot disappear while the Linux owner/type/mode integration still passes.
